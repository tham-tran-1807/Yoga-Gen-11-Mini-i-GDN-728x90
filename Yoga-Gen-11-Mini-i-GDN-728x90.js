...
lib.ssMetadata = [
		{name:"Yoga_Gen_11_Mini_i_GDN_728x90_atlas_1", frames: [[730,0,50,50],[0,0,728,90],[0,644,503,90],[0,368,594,90],[0,552,505,90],[0,276,635,90],[0,736,501,90],[0,460,585,90],[0,828,357,90],[0,92,728,90],[0,184,709,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Yoga_Gen_11_Mini_i_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.YogaGen11MiniiGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(277,0);
	...
	this.instance_4.setTransform(137,0);
	...
	this.instance_8.setTransform(128,0);
...
// library properties:
lib.properties = {
	id: '77BE86E86AD5CD4EA4DA40BFF88C7F02',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Yoga_Gen_11_Mini_i_GDN_728x90_atlas_1.png", id:"Yoga_Gen_11_Mini_i_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['77BE86E86AD5CD4EA4DA40BFF88C7F02'] = {
